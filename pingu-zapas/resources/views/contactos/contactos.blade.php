...
@section('content')
    <div class="container" style="max-width: 1000px; margin-top: 40px;">
        <div class="page-header" style="text-align: center; margin-bottom: 60px;">
            <span class="badge" style="margin-bottom: 16px;">¿Hablamos?</span>
            <h1 class="page-title" style="margin-bottom: 12px;">Contacta con PinguZapas</h1>
            <p class="muted">Estamos aquí para resolver tus dudas sobre lanzamientos, tallas o pedidos.</p>
        </div>
            ...
            <div class="panel" style="padding: 40px;">
                ...
                <form action="{{ route('contacto.store') }}" method="POST" class="form-stack">
                    ...
                    <div class="field">
                        ...
                        <textarea name="mensaje" id="mensaje" rows="6" placeholder="Cuéntanos en qué podemos ayudarte..." required>{{ old('mensaje') }}</textarea>
                    </div>
                ...
                <div class="panel" style="padding: 32px;">
                    ...
                    <div class="list-clean">
                        <div style="display: flex; gap: 16px; align-items: center; padding: 12px 0;">
                            ...
                            <div>
                                <strong style="display: block;">Nuestra Sede</strong>
                        ...
                        <div style="display: flex; gap: 16px; align-items: center; padding: 12px 0;">
                            ...
                            <div>
                                <strong style="display: block;">Email de Soporte</strong>
